 ...
 * @author bruno
 */
public class Movimientobala1 extends Thread {
    ...
    public void run() {
        while (true) {
            ...
            switch (Ventanaprincipal.movimientobala1) {
                // 0 arriba - 1 abajo
            ...
            try {
                ...
                Logger.getLogger(Movimientobala1.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
